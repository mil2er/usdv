// Just for testing contract upgrade
// symbol would be set "USDU"
// name would be set "USD Vault for upgrade"
// double value mint in _mint(...)

// Sources flattened with tronbox v4.2.0 https://tronbox.io
...
contract USDV is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, AccessControlEnumerableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable, IBeacon {
    ...
    public initializer
    {
        ...
        __ERC20_init("USD Vault just for testing upgrade", "USDU");
        __ERC20Burnable_init();
        __ERC20Pausable_init();
        __AccessControl_init();
        __AccessControlEnumerable_init();
        __ERC20Permit_init("USX EX");
